...
class Wuji(RobotInterface):
    def get_white_list_pairs(self):
        ...
        pairs = []
        seen = set()
        for pair in palm_pairs + excluded_collision_pairs:
            key = tuple(pair)
    ...
    def get_default_urdf_path(self):
        ...
        """
        return './assets/hand/wuji/mj_lab_wuji/urdf/right_mjlab.urdf'
